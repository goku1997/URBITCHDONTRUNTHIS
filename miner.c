...
void work_hash(struct work * const work)
{
	...
	printf("tart: "); for (i=0;i<0x20;i++) { printf("%02X", work->target[i]); } printf("\n");
	printf("hash: "); for (i=0;i<0x20;i++) { printf("%02X", work->hash[i]); } printf("\n");
	printf("data: "); for (i=0;i<128;i++) { printf("%02X", work->data[i]); } printf("\n");
}
...
// acd0c52a6fe1ace6dba849aa4d7f3a1f4dbb8bc2927f1f1657952832abad8c46
// 468CADAB32289557161F7F92C28BBB4D1F3A7F4DAA49A8DBE6ACE16F2AC5D0AC
